# This file is for development purposes only.  In production, there should be a
# global /etc/fedmsg-config.py on the system with a global configuration for
# this and all other messaging-enabled apps.
